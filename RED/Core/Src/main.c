...
uint8_t Print_ANGLE[20];//接收串口二获取角度
uint8_t NANO_receive_buff[255];
uint8_t ChuanKoPing_receive_buff[9];//串口屏接收数据



////////////////////////////////////
int task,ifstop;
int id0,angle_pich,id1,angle_yaw;
